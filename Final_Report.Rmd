...
As a result of our analysis, we found out that the major bacterial phyla in fecal samples are Actinobacteria, Bacteroidetes, Firmicutes, Fusobacteria and Proteobactera regardless of the diet and additives (Figure 1, Figure 2, Figure 3). 
...
```{r barplot-of-bacterial-phyla-abundance-by-diet}
...
```{r barplot-of-bacterial-phyla-abundance-in-chicken-diet}
# This code creates a barplot of the bacterial phyla abundance
# between the fecal samples of beagles obtained at the end of their
...
```{r barplot-of-bacterial-phyla-abundance-in-beef-diet}
# This code creates a barplot of the bacterial phyla abundance
# between the fecal samples of beagles obtained at the end of their
...
```{r barplot-of-bacterial-genera-abundance-by-diet}
...
In figure 4, we can see that there is a high amount of unidentified genus among all groups. Abundance of *Fusobacterium* genus is significantly high in beef and chicken diet fecal samples. *Anaerobiospirillum*, *Clostridium_XVII*, *Streptococcus* and *Sutterella* only appear in chicken diet fecal samples. *Collinsella*, *Enterococcus*, *Escherichia*, *Parabacteroides* and *Parasutterella* only appear in beef diet fecal samples. *Lactobacillus*, *Prevotella* and *Turicibacter* only appear in kibble diet fecal samples. *Alloprevotella* and *Faecalibacterium* appear in chicken and kibble diet fecal samples. *Blautia*, *Clostridium_sensu_stricto*, *Roseburia* and *Megamonas* appear in chicken and beef diet fecal samples. 

```{r barplot-of-bacterial-genera-abundance-in-chicken-diet}
# This code creates a barplot of the bacterial genera abundance
# between the fecal samples of beagles obtained at the end of their
# digestion of chicken diet with either inulin, yeast cell wall or no
...
In figure 5, we can see that abundance of *Fusobacterium* is the highest among control diet fecal samples. *Anaerobiospirillum*, *Clostridium_XVII*, *Roseburia* and *Sutterella* only appear in yeast cell wall added diet fecal samples. *Alloprevotella*, *Blautia*, *Clostridium_sensu_stricto*, *Faecalibacterium* and *Holdemanella* only appear in inulin added diet fecal samples. *Allobaculum*, *Megamonas* and *Streptococcus* appear in inuline and yeast cell wall added diet fecal samples.

```{r barplot-of-bacterial-genera-abundance-in-beef-diet}
# This code creates a barplot of the bacterial genera abundance
# between the fecal samples of beagles obtained at the end of their
# digestion of beef diet with either inulin, yeast cell wall or no
# additives. Since the number of genera is too high, I filter out 
